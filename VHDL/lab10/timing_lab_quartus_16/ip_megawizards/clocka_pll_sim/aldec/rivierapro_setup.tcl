...
# ACDS 16.1 196 win32 2017.12.19.18:49:31
# ----------------------------------------
...
# ----------------------------------------
# If clocka_pll is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clocka_pll.vho"
}
