...
# ----------------------------------------
# If clockb_pll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2017.12.19.20:32:22
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clockb_pll.vho"
}
